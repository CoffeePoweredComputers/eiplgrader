...
code_tester = CodeTester(generated_code['code'], test_cases, language="haskell")
...
# Test the generated code
code_tester = CodeTester(generated_code['code'], test_cases, function_name="sumNums", language="haskell")
test_result = code_tester.run_tests()
print(test_result, end="\n\n")
...
# Test the generated code
code_tester = CodeTester(generated_code['code'], test_cases, function_name="sumsNumbers", language="haskell")
test_result = code_tester.run_tests()
print(f"Test result: {test_result}", end="\n\n")
...
generated_code = code_generator.generate_code(
    "folds over a list of integers at each point adding the current number to an accumulator and, at the end, returning the accumulator.",
    segmentation_few_shot_file="segmentation_few_shot.json",
    params="lst",
    assumptions="lst is a list of integers",
    model="gpt-4o",
    language="haskell"
)
