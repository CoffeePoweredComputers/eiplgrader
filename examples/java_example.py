...
code_tester = CodeTester(generated_code['code'], test_cases, language="java")
...
# Test the generated code
code_tester = CodeTester(generated_code['code'], test_cases, function_name="sumNums", language="java")
test_result = code_tester.run_tests()
print(test_result, end="\n\n")
...
# Test the generated code
code_tester = CodeTester(generated_code['code'], test_cases, function_name="sumsNumbers", language="java")
test_result = code_tester.run_tests()
print(f"Test result: {test_result}", end="\n\n")
...
generated_code = code_generator.generate_code(
    ...
    params="arr",
    assumptions="arr is an array of integers",
    model="gpt-4o",
    language="java"
)
