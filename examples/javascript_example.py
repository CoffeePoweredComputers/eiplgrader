...
code_tester = CodeTester(generated_code['code'], test_cases, language="javascript")
...
# Test the generated code
code_tester = CodeTester(generated_code['code'], test_cases, function_name="sumNums", language="javascript")
test_result = code_tester.run_tests()
print(test_result, end="\n\n")
...
# Test the generated code
code_tester = CodeTester(generated_code['code'], test_cases, function_name="sumsNumbers", language="javascript")
test_result = code_tester.run_tests()
print(f"Test result: {test_result}", end="\n\n")
