...
test_cases = [
    ...
    {"parameters": {"s": "a"}, "expected": True, "parameter_types": {"s": "string"}, "expected_type": "bool"},
    {"parameters": {"s": ""}, "expected": True, "parameter_types": {"s": "string"}, "expected_type": "bool"},
]
...
print("- JSON-capable languages (Python, JS): Types optional, inferred from values")
print("- Static type languages (C, C++, Java, Go, Haskell): Exact native types required")
