...
code_tester = CodeTester(generated_code['code'], test_cases, language="cpp")
...
# Test the generated code
code_tester = CodeTester(generated_code['code'], test_cases, function_name="sum_nums", language="cpp")
test_result = code_tester.run_tests()
print(test_result, end="\n\n")
...
# Test the generated code
code_tester = CodeTester(generated_code['code'], test_cases, function_name="sums_numbers", language="cpp")
test_result = code_tester.run_tests()
print(f"Test result: {test_result}", end="\n\n")
...
generated_code = code_generator.generate_code(
    ...
    params="vec",
    assumptions="vec is a vector of integers",
    model="gpt-4o",
    language="cpp"
)
