...
code_tester = CodeTester(generated_code['code'], test_cases, language="kotlin")
...
# Test the generated code
code_tester = CodeTester(generated_code['code'], test_cases, function_name="sumNums", language="kotlin")
test_result = code_tester.run_tests()
print(test_result, end="\n\n")
...
# Test the generated code
code_tester = CodeTester(generated_code['code'], test_cases, function_name="sumsNumbers", language="kotlin")
test_result = code_tester.run_tests()
print(f"Test result: {test_result}", end="\n\n")
...
generated_code = code_generator.generate_code(
    "iterates through a list of integers at each point adding the current number to a sum var and, at the end, returning that var.",
    segmentation_few_shot_file="segmentation_few_shot.json",
    params="list",
    assumptions="list is a list of integers",
    model="gpt-4o",
    language="kotlin"
)

test_cases = [
    {"parameters": {"list": [1, 2, 3]}, "expected": 6},
    {"parameters": {"list": [5, 7, 8]}, "expected": 20},
    {"parameters": {"list": [-1, 1, 0]}, "expected": 0},
]
