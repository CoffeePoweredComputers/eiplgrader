...
code_tester = CodeTester(generated_code['code'], test_cases, language="c")
...
# Test the generated code
code_tester = CodeTester(generated_code['code'], test_cases, function_name="sum_nums", language="c")
test_result = code_tester.run_tests()
print(test_result, end="\n\n")
...
# Test the generated code
code_tester = CodeTester(generated_code['code'], test_cases, function_name="sums_numbers", language="c")
test_result = code_tester.run_tests()
print(f"Test result: {test_result}", end="\n\n")
...
generated_code = code_generator.generate_code(
    "iterates through an array of integers at each point adding the current number to a sum var and, at the end, returning that var.",
    segmentation_few_shot_file="segmentation_few_shot.json",
    params="arr, size",
    assumptions="arr is an array of integers and size is the array length",
    model="gpt-4o",
    language="c"
)

test_cases = [
    {"parameters": {"arr": [1, 2, 3], "size": 3}, "expected": 6},
    {"parameters": {"arr": [5, 7, 8], "size": 3}, "expected": 20},
    {"parameters": {"arr": [-1, 1, 0], "size": 3}, "expected": 0},
]
