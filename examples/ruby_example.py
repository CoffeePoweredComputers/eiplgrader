...
code_tester = CodeTester(generated_code['code'], test_cases, language="ruby")
...
# Test the generated code
code_tester = CodeTester(generated_code['code'], test_cases, function_name="sum_nums", language="ruby")
test_result = code_tester.run_tests()
print(test_result, end="\n\n")
...
# Test the generated code
code_tester = CodeTester(generated_code['code'], test_cases, function_name="sums_numbers", language="ruby")
test_result = code_tester.run_tests()
print(f"Test result: {test_result}", end="\n\n")
