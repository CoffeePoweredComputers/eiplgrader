...
code_tester = CodeTester(generated_code['code'], test_cases, language="ocaml")
...
# Test the generated code
code_tester = CodeTester(generated_code['code'], test_cases, function_name="sum_nums", language="ocaml")
test_result = code_tester.run_tests()
print(test_result, end="\n\n")
...
# Test the generated code
code_tester = CodeTester(generated_code['code'], test_cases, function_name="sums_numbers", language="ocaml")
test_result = code_tester.run_tests()
print(f"Test result: {test_result}", end="\n\n")
