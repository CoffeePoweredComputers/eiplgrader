...
code_tester = CodeTester(generated_code['code'], test_cases, language="typescript")
...
# Test the generated code
code_tester = CodeTester(generated_code['code'], test_cases, function_name="sumNums", language="typescript")
test_result = code_tester.run_tests()
print(test_result, end="\n\n")
...
# Test the generated code
code_tester = CodeTester(generated_code['code'], test_cases, function_name="sumsNumbers", language="typescript")
test_result = code_tester.run_tests()
print(f"Test result: {test_result}", end="\n\n")
...
generated_code = code_generator.generate_code(
    "iterates through an array of numbers at each point adding the current number to a sum var and, at the end, returning that var.",
    segmentation_few_shot_file="segmentation_few_shot.json",
    params="arr",
    assumptions="arr is an array of numbers",
    model="gpt-4o",
    language="typescript"
)
...
test_cases = [
    ...
    {"parameters": {"arr": [5, 7, 8]}, "expected": 20},
    {"parameters": {"arr": [-1, 1, 0]}, "expected": 0},
]
