...
class TestCompilationWorkflowBase:
    ...
    def test_compilation_failure_workflow(self, mock_run):
        ...
        mock_run.return_value = Mock(
            returncode=1, 
            stderr="error: 'undeclared_var' undeclared",
            stdout=""
        )
...
class TestJavaCompilationWorkflow:
    ...
    def test_java_compilation_errors(self, mock_run):
        ...
        try:
            ...
            mock_run.return_value = Mock(
                returncode=1,
                stderr="Test.java:1: error: ';' expected",
                stdout=""
            )
            ...
            mock_run.return_value = Mock(
                returncode=1,
                stderr="Test.java:1: error: cannot find symbol",
                stdout=""
            )
...
class TestGoCompilationWorkflow:
    ...
    def test_go_compilation_errors(self, mock_run):
        ...
        try:
            ...
            mock_run.return_value = Mock(
                returncode=2,
                stderr="test.go:5:2: undefined: undeclaredVar",
                stdout=""
            )
...
class TestCompilation ExecutionIntegration:
...
class TestCompilationErrorRecovery:
    ...
    def test_partial_compilation_recovery(self, mock_run):
        ...
        try:
            ...
            mock_run.return_value = Mock(
                returncode=0,
                stderr="warning: unused parameter 'x'",
                stdout=""
            )
