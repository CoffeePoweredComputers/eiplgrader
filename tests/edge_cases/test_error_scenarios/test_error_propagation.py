...
class TestCompilationErrorPropagation:
    ...
    def test_missing_header_error_propagation(self, mock_run):
        ...
        try:
            with patch.object(executor, 'prepare_code', return_value="#include <nonexistent.h>"):
    ...
    def test_linker_error_propagation(self, mock_run):
        ...
        try:
            with patch.object(executor, 'prepare_code', return_value="calls missing_function"):
                test_case = {"parameters": {}, "expected": ""}
    ...
    def test_compilation_warning_handling(self, mock_run):
        ...
        compile_result = Mock(
            returncode=0,
            stderr="test.c:5:10: warning: unused variable 'x'",
            stdout=""
        )
        # Execution succeeds
        execute_result = Mock(
        ...
        try:
            with patch.object(executor, 'prepare_code', return_value="code with warnings"):
...
ZeroDivisionError: division by zero"""
        ...
        try:
            with patch.object(executor, 'prepare_code', return_value="division by zero"):
                test_case = {"parameters": {}, "expected": ""}
...
ReferenceError: undefinedVar is not defined
    at Object.<anonymous> (test.js:3:13)"""
        ...
        try:
            with patch.object(executor, 'prepare_code', return_value="undefined variable"):
                test_case = {"parameters": {}, "expected": ""}
...
RecursionError: maximum recursion depth exceeded"""
        ...
        try:
            with patch.object(executor, 'prepare_code', return_value="recursive function"):
                test_case = {"parameters": {}, "expected": ""}
...
class TestSystemErrorPropagation:
    ...
    def test_file_not_found_error_propagation(self, mock_run):
        ...
        mock_run.side_effect = FileNotFoundError("No such file or directory: 'nonexistent_compiler'")
...
class TestRegistryErrorPropagation:
    ...
    def test_adapter_instantiation_error(self):
        ...
        class ErrorAdapter(LanguageAdapter):
            ...
            def generate_prompt(self, *args, **kwargs): pass
            def extract_code(self, response): pass
            def normalize_code(self, code): pass
