  ...
  a + b
    ...
    def test_ruby_specific_prompt_generation(self):
        ...
        prompt = adapter.generate_prompt(
            "reverse a string", "reverse_string", gen_type="cgbg"
        )
...
"""
        test_case = {
            ...
            "parameters": {"hash1": {"a": 1, "b": 2}, "hash2": {"b": 3, "c": 4}},
...
"""
    ...
    def test_ruby_error_handling(self):
        ...
        test_case = {"function_name": "broken", "parameters": {}, "expected": None}
...
"""
    ...
    def test_multiple_generation_versions(self):
        ...
        adapter = RubyAdapter()
        prompt = adapter.generate_prompt(
            "calculate the sum of an array", "array_sum", gen_type="cgbg", num_to_gen=3
        )
